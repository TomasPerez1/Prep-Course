...
function elevarAlCuadrado(num) {
  ...
  // Tu código:
  var resultadoalcuadrado = Math.pow(num,2);
...
function elevarAlCubo(num) {
  ...
  // Tu código:
  var resultadoalcubo = Math.pow(num,3);
...
function obtenerSaludo(nombre) {
  ...
  // Tu código:
  var saludo = 'Hola ';
  var nombreconsaludo = saludo.concat(nombre,'!')
